...
namespace Old_School_FFA
{
    public partial class OS_FFA
    {
        ...
        private static string[] OS_Models { get { return _ListWeapons.Select(wep => wep.Split(';')[1]).ToArray(); } }
        private static string[] _ListWeapons = {  "iw5_m4_mp;weapon_m4_iw5",
        ...
        private static Vector3[] targetZone_seatown = { 
                                                       new Vector3(-1226, -1399, 204),
        ...
        private static Vector3[] targetZone_dome = {
                                                       new Vector3(97, 898, -240),
        ...
        private static Vector3[] targetZone_arkaden = {
                                                       new Vector3(221, 440, 754),
        ...
        private static Vector3[] targetZone_bakaara = {
                                                       new Vector3(1448, 1945, 39),
        ...
        private static Vector3[] targetZone_resistance = {
                                                       new Vector3(-931, -921, 110),
        ...
        private static Vector3[] targetZone_downturn = {
                                                       new Vector3(-614, 1286, 113),
        ...
        private static Vector3[] targetZone_bootleg = {
                                                       new Vector3(-1432, 1404, 8),
        ...
        private static Vector3[] targetZone_carbon = {	
                                                       new Vector3(-3330, -3392, 3630),
        ...
        private static Vector3[] targetZone_hardhat = {	
                                                       new Vector3(2035, -229, 246),
        ...
        private static Vector3[] targetZone_lockdown = {	
                                                       new Vector3(-1979, 1653, 148),
        ...
        private static Vector3[] targetZone_village = {	
                                                       new Vector3(647, 1891, 332),
        ...
        private static Vector3[] targetZone_fallen = {	
                                                       new Vector3(-293, -1286, -180),
        ...
        private static Vector3[] targetZone_outpost = {	
                                                       new Vector3(-3482, -498, 1222),
        ...
        private static Vector3[] targetZone_interchange = {	
                                                       new Vector3(2465, -402, 149),
        ...
        private static Vector3[] targetZone_underground = {
                                                       new Vector3(-602, 3072, -68),
        ...
        private static Vector3[] targetZone_mission = {
                                                       new Vector3(-1359, 608, 975),
